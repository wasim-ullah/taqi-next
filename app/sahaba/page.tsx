  ...
  return (
    <>
      ...
      <header className="max-w-3xl mx-auto px-4 pt-16 pb-10 border-b border-[#1a1a1a]">
        <p className="text-[10px] uppercase tracking-widest text-[#555] mb-6">Generation II</p>
        <p
          ...
          {people.map((p) => {
            ...
            return (
              <Link
                key={p.id}
                href={`/sahaba/${p.slug}`}
                className="bg-black p-6 group hover:bg-[#080808] transition-colors flex items-start justify-between"
              >
                ...
                <div className="ml-8 text-right flex-shrink-0">
                  ...
                  <p className="text-[10px] uppercase tracking-widest text-[#555] group-hover:text-[#888] transition-colors">
                    Read →
                  </p>
                </div>
              </Link>
